...
class Sql
{
    ...
    {
        $hash1 = Hash::make(bin2hex(openssl_random_pseudo_bytes(16)));
        $hash2 = Hash::make(bin2hex(openssl_random_pseudo_bytes(16)));
        $hash3 = Hash::make(bin2hex(openssl_random_pseudo_bytes(16)));
